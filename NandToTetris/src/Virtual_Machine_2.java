import java.io.*;
import java.util.*;
public class Virtual_Machine_2 {
	...
	public static String filename = "//Users//VarshiniSelvadurai//Desktop//nand2tetris//projects//12//";
	public static String ugh = "";
	public static Scanner input = null;
	public static PrintWriter pw = null; 
	public static void main(String[] args) {
		try {
			pw = new PrintWriter(filename+"Math.asm","UTF-8");
	...
	public static void repeat(String name){
		File file = new File(filename+name+".vm");
		ugh = name;
		String[] word;
		String write;
		try{
